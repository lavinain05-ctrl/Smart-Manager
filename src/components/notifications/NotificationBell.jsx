          ...
          <div className="max-h-96 overflow-y-auto divide-y divide-slate-100">
            {notifications.length === 0 ? (
              <div className="p-8 text-center text-slate-400">
                ...
                <p className="text-xs text-slate-400 mt-0.5">Society updates will appear here in real-time</p>
              </div>
            ) : (
              notifications.slice(0, 25).map((notif) => {
                ...
                return (
                  ...
                  >
                    {/* Type Icon */}
                    <div className="w-8 h-8 rounded-xl bg-slate-100 flex items-center justify-center shrink-0 mt-0.5 text-sm">
                      {icon}
                    </div>
