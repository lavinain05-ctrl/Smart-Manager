...
const pageTitles = {
  ...
  "/admin/suggestions": { title: "Suggestions Box", subtitle: "Review and respond to resident proposals" },
  ...
  "/admin/devices": { title: "Active Devices & Logins", subtitle: "Monitor logged-in devices and manage active sessions" },
  "/admin/active-sessions": { title: "Active Devices & Logins", subtitle: "Monitor logged-in devices and manage active sessions" },
